...
//
// Siddharth Kalidindi | SCU | CSEN | 3/12/24
...
#pragma mark - Member Function Implementation
    ...
    void bag<Item>::operator +=(const bag<Item>& addend)
    {
        ...
        {
            // STUDENT WORK
	    binary_tree_node<Item> *temp_bag_root;
            temp_bag_root = tree_copy(addend.root_ptr);
            insert_all(temp_bag_root);
            delete temp_bag_root;
        }
        else
